namespace Dark_Souls_II_Save_Editor.STFSPackage
{
    ...
    {
        internal byte blockAlignment;
        internal bool blockAlignmentStored;
        // calculated
        internal int blockHeaderSize;
        internal byte blockIDSize;
        internal byte blockSpanSize;
        internal uint blockStartAddress;
        internal byte[] guid = new byte[0x10];
    ...
    {
        private uint assetTypeDetails;
        private AssetSubcategory category;
        private AssetGender gender;
        private byte metadataVersion;
        private SkeletonVersion skeletonVersion;
        private BinaryAssetType type;
    }
    ...
    internal struct ColorTableEntry
    {
        private ColorGroup color1, color2, color3;
    }

    internal struct ColorTable
    {
        private uint count;
        private ColorTableEntry[] entries;
    }
    ...
    internal struct STRBBlock
    {
        private byte[] data;
        private uint dataAddress;
        private int dataLength;
        private int fieldSize;
        private STRRBBlockId id;
    }
}